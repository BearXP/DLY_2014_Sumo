...
const SWord TARGETING_DIST = 1000;
const SWord PUSH_DISTANCE = 500;
...
public:
	...
	bool lostTarget()
	{
		Word dist = min(sensors[fLeft]->ReadSensorDist(), sensors[fRight]->ReadSensorDist());
		return (dist > TARGETING_DIST+READING_ERROR);
    }
private:
	enum Sensors
	{
