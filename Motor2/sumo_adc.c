...
void A2DConverter::enable()
{
	...
	// disable digital input pins for ADC8 - ADC14
	DIDR2 |= (_BV(ADC8D) |_BV(ADC9D) |_BV(ADC10D) |_BV(ADC11D) | _BV(ADC12D) | _BV(ADC13D) | _BV(ADC14D));
}
...
Word A2DConverter::getSample(Byte input)
{
	// select the mux value
	//limited to 0-3 and 8-14
	if(input<=3)
	{
